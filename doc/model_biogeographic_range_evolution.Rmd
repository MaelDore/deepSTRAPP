...
It builds mainly upon functions from R package `[BioGeoBEARS]` to offer a simplify framework to model and visualize __biogeographic range evolution__ on a time-calibrated phylogeny. <br>
