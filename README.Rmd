...
**Need to find a simple example with enough regime shifts to find significant results, and ideally, non-significicant results in the present, but a significant time-frame in the past**
...
plot_rates_through_time(STRAPP_tests_over_time = Ponerinae_deepSTRAPP_0_40)
```
