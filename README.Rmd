...
```
```{r plot_trait_vs_rate_maps_cat_2lvl_eval, fig.height = 7, eval = TRUE, echo = FALSE}
# Plot both mapped phylogenies in the present (t = 0)
plot_trait_vs_rate_maps_for_focal_time(
  deepSTRAPP_outputs = Ponerinae_deepSTRAPP_cat_2lvl_old_calib_0_40,
  focal_time = 0,
...
Show how to plot rates vs. trait values/states from the melted df for each focal time
Make it a function??? And include it in the README + vignette for each deepSTRAPP workflow + the STRAPP test options
