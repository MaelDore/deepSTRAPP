...
# Contain all datasets, including deepSTRAPP outputs for all four types of data
...
## 1.2/ Replace datasets documentation
...
## 1.3/ Add pre-rendered visual outputs to the vignette folder
