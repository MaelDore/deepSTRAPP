...
Source: Rabosky, D. L. (2014). Automatic detection of key innovations,
rate shifts, and diversity-dependence on phylogenetic trees. PloS one,
9(2), e89543.  

DOI:
[10.1371/journal.pone.0089543](https://doi.org/10.1371/journal.pone.0089543)  
BAMM website: <http://bamm-project.org/>

  
deepSTRAPP builds upon **BAMM** and functions from R package
`[BAMMtools]` to offer a simplified framework to model and visualize
**diversification dynamics** on a **time-calibrated phylogeny**.  
...
all-in-one function to infer diversification dynamics, please see the
...
![](figures/whale_MCMC_trace_logLik.png)
...
![](figures/whale_PP_nb_shifts_plot.png)
...
![](model_diversification_dynamics_files/figure-html/explore_diversity_dynamics_eval-1.png)![](model_diversification_dynamics_files/figure-html/explore_diversity_dynamics_eval-2.png)![](model_diversification_dynamics_files/figure-html/explore_diversity_dynamics_eval-3.png)![](model_diversification_dynamics_files/figure-html/explore_diversity_dynamics_eval-4.png)![](model_diversification_dynamics_files/figure-html/explore_diversity_dynamics_eval-5.png)
