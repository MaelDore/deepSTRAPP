...
It builds mainly upon functions from R package `[BioGeoBEARS]` to offer
a simplified framework to model and visualize **biogeographic range
evolution** on a time-calibrated phylogeny.  
Please, cite also the initial R package if you are using deepSTRAPP for
this purpose.
...
For an example with **categorical data**, see this vignette:
...
![](model_biogeographic_range_evolution_files/figure-html/model_trait_evolution_biogeo_eval-1.png)![](model_biogeographic_range_evolution_files/figure-html/model_trait_evolution_biogeo_eval-2.png)
...
![](model_biogeographic_range_evolution_files/figure-html/model_trait_evolution_biogeo_eval-3.png)![](model_biogeographic_range_evolution_files/figure-html/model_trait_evolution_biogeo_eval-4.png)![](model_biogeographic_range_evolution_files/figure-html/model_trait_evolution_biogeo_eval-5.png)
