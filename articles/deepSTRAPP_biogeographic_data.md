...
areas**. It presents the main functions in a typical **deepSTRAPP
workflow**.
...
For an example with **binary data** (2 levels), please see the example
in the **Main tutorial**:
[`vignette("main_tutorial")`](https://maeldore.github.io/deepSTRAPP/articles/main_tutorial.md).

For an example with **categorical multinomial data**, see this vignette:
...
all-in-one functions to infer trait evolution and diversification
dynamics, please see the examples in this vignette:
[`vignette("import_external_analyses")`](https://maeldore.github.io/deepSTRAPP/articles/import_external_analyses.md).

  

The R package `BioGeoBEARS` is needed for this workflow to process
biogeographic data.  
...
## Inputs needed for Step 3 are the densityMaps (Ponerinae_densityMaps), and optionally,
...
Ponerinae_deepSTRAPP_biogeo_old_calib_0_40 <- run_deepSTRAPP_over_time(
    ...
    # Deal with uncertainty in estimates by pairing ranges 
...
# Range data were extracted from densityMaps recording only frequency of ranges.
# Thus, ranges have been distributed accordingly across 100 'Dummy_maps'
# to reproduce the recorded frequencies.
table(Ponerinae_deepSTRAPP_biogeo_old_calib_0_40$trait_data_df_over_time$Map_ID)
...
str(Ponerinae_deepSTRAPP_biogeo_old_calib_0_40$updated_trait_Maps_over_time, max.level = 2)
...
![](figures/1.3_deepSTRAPP_biogeographic_data_4.1_plot_pvalues.PNG)
...
# Since this red line is above the null expectation (quantile 10% = 278.8),
...
![](figures/1.3_deepSTRAPP_biogeographic_data_4.2_plot_STRAPP_tests.PNG)
...
# with differences detected as significant between ca. 8 to 28 My.
...
![](figures/1.3_deepSTRAPP_biogeographic_data_4.3_plot_rates_through_time.PNG)
...
# You can see that "Old World" ants tend to have higher mean rates than "New World" ants, at this time-step.
...
#   * The p-value of the associated STRAPP test. Here, p = 0.089.
...
![](figures/1.3_deepSTRAPP_biogeographic_data_4.4_plot_rates_vs_traits.PNG)
...
densityMaps_0My <- Ponerinae_deepSTRAPP_biogeo_old_calib_0_40$updated_Maps_over_time[[1]]
...
densityMaps_10My <- Ponerinae_deepSTRAPP_biogeo_old_calib_0_40$updated_Maps_over_time[[3]]
...
densityMaps_40My <- Ponerinae_deepSTRAPP_biogeo_old_calib_0_40$updated_Maps_over_time[[9]]
...
![](figures/1.3_deepSTRAPP_biogeographic_data_4.5_plot_updated_densityMaps_1.PNG)![](figures/1.3_deepSTRAPP_biogeographic_data_4.5_plot_updated_densityMaps_2.PNG)
...
![](figures/1.3_deepSTRAPP_biogeographic_data_4.6_plot_BAMM_rates.PNG)
...
![](figures/1.3_deepSTRAPP_biogeographic_data_4.7_plot_traits_vs_rate_maps_1.PNG)![](figures/1.3_deepSTRAPP_biogeographic_data_4.7_plot_traits_vs_rate_maps_2.PNG)
