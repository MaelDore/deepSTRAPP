...
from the present day to any time step along a phylogeny.
...
Simplified deepSTRAPP workflow showing the main functions *(in italics)*
involved in each step**. Input data in grey. Data processing in blue
(main) and beige (internal). Intermediate objects in green. Final
outputs in pink.
...
> (2014). DOI: <https://doi.org/10.1371/journal.pone.0089543>  
