...
#'   * `$contMaps` List of `"contMap"` objects that represent simulations of trait evolution conditioned on the observed data and evolutionary model fit
...
#'   updated trait data objects, and updated BAMM objects, that are required for downstream plots and analyses.
#'
#'   The object can be loaded with:
