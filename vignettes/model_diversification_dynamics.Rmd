---
title: "Model diversification dynamics"
author: "Maël Doré"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Model diversification dynamics}
...
__BAMM (Bayesian Analysis of Macroevolutionary Mixtures)__ is a fully independent C++ software developed by Daniel L. Rabosky. You need to install BAMM first on your machine to be able to run this section of deepSTRAPP.
...
<br>
deepSTRAPP builds upon __BAMM__ and functions from R package `[BAMMtools]` to offer a simplified framework to model and visualize __diversification dynamics__ on a __time-calibrated phylogeny__.
<br>

For a detailed explanation on how to load results from __external analyses__ within deepSTRAPP rather than relying on deepSTRAPP all-in-one function to infer diversification dynamics, please see the example in this vignette: `vignette("import_external_analyses")`.
