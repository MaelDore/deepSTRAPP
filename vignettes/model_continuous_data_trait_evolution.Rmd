...
It builds mainly upon functions from R packages `[geiger]` and `[phytools]` to offer a simplify framework to model and visualize __continuous trait evolution__ on a __time-calibrated phylogeny__.
