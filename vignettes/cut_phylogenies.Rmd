...
These functions can be used to cut any (mapped) phylogenies outside of a deepSTRAPP run including a regular phylogeny, contMap(s), densityMap(s), simmap(s), and BAMM_object with diversification rates.
...
```
```{r cut_simmaps_eval, fig.width = 15, fig.height = 12, out.width = "100%", eval = TRUE, echo = FALSE}
