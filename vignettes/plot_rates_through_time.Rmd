...
The plot can be performed on different types of data (i.e., continuous, binary, and multinomial). <br>
Below are examples with __continuous data__ (Example 1) and __categorical multinomial data__ (Example 2).
