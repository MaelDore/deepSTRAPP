...
For an example with __categorical multinomial data__, see this vignette: `vignette("deepSTRAPP_categorical_data")`.

<br>
For a detailed explanation on how to load results from __external analyses__ within deepSTRAPP rather than relying on deepSTRAPP all-in-one functions to infer trait evolution and diversification dynamics, please see the examples in this vignette: `vignette("import_external_analyses")`.
