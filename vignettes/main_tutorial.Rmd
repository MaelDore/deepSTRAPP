...
vignette: >
  %\VignetteIndexEntry{main_tutorial}
...
It presents the main functions in a typical **deepSTRAPP workflow**. For more advanced used, please refer to the vignettes/tutorials listed here: `vignette("deepSTRAPP")`.
...
```{r plot_trait_vs_rate_maps_main_tutorial}
...
```
```{r plot_trait_vs_rate_maps_main_tutorial_eval, fig.height = 7, eval = TRUE, echo = FALSE}
# Plot both mapped phylogenies in the present (t = 0)
plot_trait_vs_rate_maps_for_focal_time(
  deepSTRAPP_outputs = Ponerinae_deepSTRAPP_cat_2lvl_old_calib_0_40,
  focal_time = 0,
