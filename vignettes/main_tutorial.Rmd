...
It presents the main functions in a typical **deepSTRAPP workflow**. For more advanced uses, please refer to the vignettes/tutorials listed [here](https://maeldore.github.io/deepSTRAPP/articles/deepSTRAPP.html): `vignette("deepSTRAPP")`.
